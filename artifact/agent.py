...
#   print(f"\n>>> User Query: {query}")
  ...
  # Load the image to inject into the prompt
  [fileInBytes, fileMimeType] = load_image_as_binary()
  ...
  content = types.Content(
      ...
      parts=[
          ...
          types.Part(inline_data=types.Blob(mime_type=fileMimeType, data=fileInBytes)),
...
async def run_conversation():
    await call_agent_async("What is the internal marks and the total grade of the subject with papercode '116252'?",
                                       runner=runner,
                                       user_id=USER_ID,
                                       session_id=SESSION_ID)
